...
import 'package:posyandu/data/models/notifikasi_item_models.dart';
import 'package:posyandu/presentation/widget/notifikasi/statuscard.dart';
...
class _NotifikasiState extends State<Notifikasi> {
  final List<NotificationItem> _notifications = [
    const NotificationItem(
        text: 'Kelulusan tahun 2024',
        icon: Icons.check_circle,
        status: 'Approved'),
    const NotificationItem(
        text: 'Sistem Informasi', icon: Icons.cancel, status: 'Rejected'),
    const NotificationItem(
        text: 'Teknik Informatika',
        icon: Icons.check_circle,
        status: 'Approved'),
    const NotificationItem(
        text: 'Tidak jadi sunatan', icon: Icons.cancel, status: 'Rejected'),
